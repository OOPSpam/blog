...
You're not alone if you're NOT receiving email notifications from your [Elementor Forms](https://elementor.com/pages/form-builder/) on your website. The plugin uses the built-in *wp_mail* function to send your email notifications. Unfortunately, many hosting providers don't configure this properly, leading to emails being marked as spam or not delivered at all.
...
I'll keep this section brief. To resolve the issue of Elementor Forms not sending email notifications, you need to get these 3 things right:
