...
4. **Test the Form**
5. * Submit test responses, including both legitimate and spammy submissions. Examples:
...
4. **Test the Trigger**
5. * Run a test to verify that Zapier successfully retrieves sample data from your form.
...
1. **Add a Filter Step**
2. * Click on the "**+**" button after the OOPSpam step in your Zap workflow.
...
2. * Add [Google Sheets](https://workspace.google.com/products/sheets/) to your Zap.

   * Choose “**Create Spreadsheet Row**” as the action event.
3. **Connect Your Google Account**
4. * If you haven’t already connected your Google account, Zapier will prompt you to do so.

   * Grant access to enable Zapier to write data to your Google Sheets.
5. **Configuring the Google Sheets Action**
...
1. * Verify that only valid submissions are added to the spreadsheet.
...
3. * Spam submissions should be flagged and discarded.
