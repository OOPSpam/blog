...
[Our WordPress plugin](https://wordpress.org/plugins/oopspam-anti-spam/) is another way to stop spam on your WPForms and WordPress comments. The plugin works with OOPSpam API that protects over 500K websites daily. Both hCaptcha and reCaptcha are free except the Custom Captcha, OOPSpam is a premium service and comes with 40 spam checks/m  to test and see the difference.
